        ...
        <div className="w-full max-w-md">
          <Card className="shadow-2xl border-2 border-gray-200">
            <CardHeader className="bg-gradient-to-r from-[#1877f2] to-[#166fe5] text-white">
              <CardTitle className="text-center text-2xl">Advocate Login</CardTitle>
              <CardDescription className="text-gray-100 text-center">Enter your registered email to receive OTP</CardDescription>
            </CardHeader>
            <CardContent className="pt-6 bg-white">
              ...
              <div className="mt-6 text-center space-y-2">
                <p className="text-sm text-gray-600">
                  New advocate?{' '}
                  <a href="/advocate/register" className="text-[#1877f2] hover:underline font-semibold">
                    Register here
                  </a>
                </p>
                <p className="text-sm text-gray-600">
                  <a href="/client" className="text-[#1877f2] hover:underline font-semibold">
                    Client Portal
                  </a>
                </p>
              </div>
