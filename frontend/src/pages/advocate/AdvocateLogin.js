        ...
        <div className="w-full max-w-5xl grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6 hidden md:block">
            <h1 className="text-5xl font-light leading-tight">
              Professional
              <span className="block font-serif italic text-amber-400">legal services</span>
            </h1>
            <p className="text-xl text-white/80 font-light tracking-wide">
              Empowering advocates • Serving justice
            </p>
          ...
          <div>
            <Card className="bg-white/95 backdrop-blur-lg shadow-2xl border-0 overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-amber-800 to-amber-900 text-white pb-8">
                <CardTitle className="text-center text-2xl font-light tracking-wide">Advocate Portal</CardTitle>
                <CardDescription className="text-amber-100 text-center font-light">Access your professional dashboard</CardDescription>
              </CardHeader>
